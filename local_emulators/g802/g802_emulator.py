"""G802 paper-live emulator (Linux/cloud)."""
...
EQUITY_USD=100.0; SIZE_PCT=0.2; LEVERAGE=20.0; THRESHOLD=80; HOLD_BARS=36
MAX_CONC=5; ATR_GUARD_PCT=10.0; ATR_MIN_PCT=3.0; COST_BPS_RT=16.0; CYCLE_SECONDS=300
...
def main():
    log(f"=== G802 emulator START === eq=${EQUITY_USD} size={SIZE_PCT} lev={LEVERAGE}x thr={THRESHOLD} hold={HOLD_BARS}h max_conc={MAX_CONC} atr_guard={ATR_GUARD_PCT}%")
