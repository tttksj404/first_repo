"""G405 paper-live emulator (Linux/cloud)."""
...
EQUITY_USD=100.0; SIZE_PCT=0.2; LEVERAGE=20.0; THRESHOLD=80; HOLD_BARS=24
...
def main():
    log(f"=== G405 emulator START === eq=${EQUITY_USD} size={SIZE_PCT} lev={LEVERAGE}x thr={THRESHOLD} hold={HOLD_BARS}h max_conc={MAX_CONC} atr_guard={ATR_GUARD_PCT}%")
