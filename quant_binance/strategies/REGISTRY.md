...
| [G151](G151_freq_boost_score75/card.md) | G150 + score_min 76→75 (진입 빈도 확대 단일 변경) | draft | G150 | mode_thresholds.futures_score_min (1개) | TBD (replay/paper 재검증 대기) | — | — | reference: G150 +2050 bps/60d | reference: 50% | — | **목표: G150 대비 진입 수 증가. 현재 세션은 analyze_backtest 타임아웃으로 레퍼런스 기록만 남김. 다음 `/strategy-eval G151`로 확정 필요** |
